...
- Templates adapted from: `easy-opal` compose template ([docker-compose.yml.tpl](https://github.com/isglobal-brge/easy-opal/blob/main/src/templates/docker-compose.yml.tpl)); see also helper commands ([src/commands](https://github.com/isglobal-brge/easy-opal/tree/main/src/commands))
