...
rock-genomics:
  environment:
    - ROCK_ID=genomics  # Unique profile identifier
...
- **Volumes**: Named volumes preserve your existing data during the transition
...
After:  Opal ↔ Multiple Rock Containers (profiles)
        ├── rock-default (dsBase, dsStats)
        ├── rock-genomics (dsOmics, dsExposure)  
