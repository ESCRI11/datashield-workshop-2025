...
This workshop will be delivered at the **DataSHIELD 2025 Conference** hosted by the SIB Swiss Institute of Bioinformatics at the University of Lausanne (UniL), Switzerland, on **Tuesday, September 23rd from 13:30 to 16:30** at room **POL-338** (TBC).

# Getting started

- Review your setup: [Environment Setup](env_setup.qmd)
- Skim the essentials: [Get up to speed](up_2_speed.qmd)
- Opal vs Armadillo: [Difference](difference.qmd)
