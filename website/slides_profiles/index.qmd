...
**4. Same Foundation**
- MongoDB, volumes, network unchanged
...
```bash
# NEVER use 'docker-compose down' - loses data!
docker-compose stop
...
**Key**: Use `stop` not `down` to preserve data volumes
...
docker-compose stop
docker-compose up -d
docker-compose rm rock-oldprofile  # Cleanup
```
---
