...
Don't worry - it's not as complex as it looks! All of these files are provided in our [live deployment scripts](https://github.com/ESCRI11/datashield-workshop-2025/tree/main/scripts/live_deploy){target="_blank"}:
